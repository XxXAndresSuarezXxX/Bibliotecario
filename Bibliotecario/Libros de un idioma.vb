...
Imports System.Text
Public Class frmLibrosDeIdioma
    Private Sub frmLibrosDeIdioma_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnMostrar_Click(sender As Object, e As EventArgs) Handles btnMostrar.Click
        ...
        If dr.HasRows Then
            While dr.Read
                If dr("IdIdioma") = cmbPais.SelectedValue Then
    ...
    Private Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        Dim AD As New StreamWriter("Libros de un idioma.csv", False, Encoding.Default)
        Dim Cantidad As Integer = 0
        Dim Diferentes As Integer = 0
