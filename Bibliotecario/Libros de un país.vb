...
Public Class frmLibrosDePais
    ...
    Private Sub frmLibrosDePais_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        Dim AD As New StreamWriter("Libros de un pais.csv", False, Encoding.Default)
        Dim Cantidad As Integer = 0
        Dim Diferentes As Integer = 0
